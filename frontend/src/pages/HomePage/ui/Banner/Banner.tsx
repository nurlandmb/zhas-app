            ...
            <div className="container z-10 px-5 flex flex-col-reverse md:flex-row items-stretch gap-6">
                <div className="flex-1 px-4 py-4 rounded-xl bg-indigo-950/40">
                    ...
                    <a className="mt-4 block hover:opacity-50 duration-300 text-gray-200 " href={TechList} target='_blank'>
                        <Button color="success" size="lg">{t('banner.techList')} </Button></a>
                    ...
                    <div className="mt-4 md:mt-8 mb-4">
                        ...
                        <a className="hover:opacity-50 duration-300 mt-2 text-gray-200 flex items-center gap-2" href="tel:+77086547410" target="_blank">
                        ...
                        <a className="hover:opacity-50 duration-300 mt-2 text-gray-200 flex items-center gap-2" href="https://go.2gis.com/bhvv7" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6  md:w-8 md:h-8">
                        ...
                        <a className="hover:opacity-50 duration-300 mt-2 text-gray-200 flex items-center gap-2" href="https://go.2gis.com/018kp" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6  md:w-8 md:h-8">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                            </svg>
